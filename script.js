...
const hovertask = () => {
    ...
    divdo.classList.add("flex", "max-w-sm", "bg-black")
...
const clickla = () => {
    ...
    if (input.value == "") {
        ...
        divtask.classList.add("flex", "text-white", "justify-between", "max-w-screen-sm", "mx-auto", "bg-black", "px-12", "py-3", "ring-5", "ring-gray-300", "rounded-3xl", "shadow-xl")
        divtask.append(span)
        const divicon = document.createElement("div")
        divicon.classList.add("flex", "space-x-3")
        const divdo = document.createElement("button")
        divdo.classList.add("flex", "max-w-sm", "bg-purple-500", "font-mono", "text-black", "ring-5", "ring-gray-300", "rounded-sm", "shadow-xl", "px-6")
        ...
        divde.classList.add("flex", "max-w-sm", "bg-blue-500", "font-mono", "text-black", "ring-5", "ring-gray-300", "rounded-sm", "shadow-xl", "px-4")
